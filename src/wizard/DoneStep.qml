            ...
            ScrollView {
                ...
                Flickable {
                    ...
                    Column {
                        ...
                        Text { text: "✓ " + qsTr("Provisioning"); font.pointSize: Style.fontSizeDescription; font.family: Style.fontFamily; color: Style.formLabelColor; visible: customizationColumn.snapshot.provisioningConfigured }
